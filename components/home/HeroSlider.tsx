...
const slides: SlideData[] = [
  {
    id: 1,
    badge: "মেগা গ্যাজেট ফেস্ট ২০২৬",
    badgeIcon: "zap",
    badgeBg: "bg-amber-400",
    badgeText: "text-slate-950",
    title: "লেটেস্ট টেক ও",
    highlightText: "কম্পিউটার এক্সেসরিজ",
    description:
      "কাস্টমাইজড গেমিং পিসি, ৪কে আল্ট্রা-ওয়াইড মনিটর ও নয়েজ ক্যানসেলিং হেডফোনে সর্বোচ্চ ৪৫% পর্যন্ত নিশ্চিত ছাড়!",
    chips: ["⚡ ৪৮ ঘণ্টার ফ্ল্যাশ অফার", "🚚 সারা দেশে ফ্রি ডেলিভারি", "🛡️ অফিশিয়াল ব্র্যান্ড ওয়ারেন্টি"],
    primaryBtn: {
      text: "হট ডিল দেখুন",
      link: "/#hot-deals",
    ...
    secondaryBtn: {
      text: "গ্যাজেট কালেকশন",
      link: "/category/electronics",
    },
    image:
      "https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=800&auto=format&fit=crop&q=80",
    imageAlt: "Gaming PC and Accessories Setup",
    floatingCard: {
      title: "৪.৯/৫ স্টার রেটিং",
      subtitle: "১২,৫০০+ ভেরিফাইড কাস্টমার রিভিউ",
      icon: "⭐",
    },
